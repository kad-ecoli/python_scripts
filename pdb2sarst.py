...
#
# Tien (theor) ,Tien (emp), Miller 1987, Rose 1985
    'A':[ 129.0, 121.0, 113.0, 118.1],
    'R':[ 274.0, 265.0, 241.0, 256.0],
    'N':[ 195.0, 187.0, 158.0, 165.5],
    'D':[ 193.0, 187.0, 151.0, 158.7],
    'C':[ 167.0, 148.0, 140.0, 146.1],
    'E':[ 223.0, 214.0, 183.0, 186.2],
    'Q':[ 225.0, 214.0, 189.0, 193.2],
    'G':[ 104.0,  97.0,  85.0,  88.1],
    'H':[ 224.0, 216.0, 194.0, 202.5],
    'I':[ 197.0, 195.0, 182.0, 181.0],
    'L':[ 201.0, 191.0, 180.0, 193.1],
    'K':[ 236.0, 230.0, 211.0, 225.8],
    'M':[ 224.0, 203.0, 204.0, 203.4],
    'F':[ 240.0, 228.0, 218.0, 222.8],
    'P':[ 159.0, 154.0, 143.0, 146.8],
    'S':[ 155.0, 143.0, 122.0, 129.8],
    'T':[ 172.0, 163.0, 146.0, 152.5],
    'W':[ 285.0, 264.0, 259.0, 266.3],
    'Y':[ 263.0, 255.0, 229.0, 236.8],
    'V':[ 174.0, 165.0, 160.0, 164.5],

# extended from above
    'J':[ 199.0, 193.0, 181.0,187.05],# (L+I)/2
    'U':[ 167.0, 148.0, 140.0, 146.1], # C
    'Z':[ 224.0, 214.0, 186.0, 189.7], # (Q+E)/2
    'B':[ 194.0, 187.0, 154.5, 162.1], # (D+N)/2
    'O':[ 201.0, 191.0, 180.0, 193.1], # K
    'X':[191.02,182.19,165.99,172.92], # average for all
}
